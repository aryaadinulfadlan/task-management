...
export default function TaskCard({ task }: Props) {
  ...
  return (
    <div className="bg-card dark:bg-black/50 p-2 lg:p-3 pl-3 lg:pl-5 rounded-sm flex items-center justify-between gap-10">
        ...
        <AlertDialog>
          ...
          <AlertDialogContent className="sm:max-w-110 gap-10">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-left">
                By doing this, task{" "}
                <span className="font-bold">{task.title}</span> will be deleted
